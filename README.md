...
The following screenshots demonstrate the functionality and user interface of the Household Power Consumption Analysis web application.

### 1. Home Page
Displays the main user interface where users can enter household power consumption parameters for prediction.
<img width="1049" height="473" alt="image" src="https://github.com/user-attachments/assets/a87d41af-0431-4843-99e8-47be6ba19edf" />

---

### 2. Input & Prediction Page
Shows the user entering power consumption details and interacting with the prediction system.

<img width="1046" height="463" alt="image" src="https://github.com/user-attachments/assets/9c8d9daa-f00b-44d7-859b-267b3cfe9bd1" />

---

### 3. Prediction Result Page
Displays the predicted power consumption analysis and energy usage insights generated by the machine learning model.

<img width="1044" height="460" alt="image" src="https://github.com/user-attachments/assets/5b0760b5-0240-4235-89d9-f184ac005cf3" />
